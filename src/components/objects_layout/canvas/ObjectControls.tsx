  ...
  return (
    <div className="z-50 absolute top-[350px] right-5 text-white font-sans text-sm bg-gray-900/90 bg-opacity-90 p-5 rounded-lg w-[270px]">
      <div className="flex justify-between items-center mb-4">
        <p className="text-lg font-bold">Object Controls</p>
        <button
          onClick={handleClose}
      ...
      <div className="mb-4">
        <p className="text-sm font-medium mb-1">Individual Scale</p>
      ...
      <div className="mb-4">
        <p className="text-sm font-medium mb-1">Quick Rotation (90°)</p>
        <div className="grid grid-cols-3 gap-3">
          {['X', 'Y', 'Z'].map((axis, index) => (
      ...
      <div className="mb-6">
        <p className="text-sm font-medium mb-1">Fine Rotation (degrees)</p>
